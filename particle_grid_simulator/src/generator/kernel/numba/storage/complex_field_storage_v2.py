...
class NumbaComplexCSRGeneratorStorage(ICSRGeneratorStorage):
    ...
    def __init__(self, contract: GeneratorKernelDataContract) -> None:
        ...
        empty_indices = np.empty(0, dtype=np.int64)  # Strict 64-bit to prevent Segfaults
    ...
    # ==========================================
    @property
    def fast_refs(self) -> GeneratorKernelFastRef: return self._fast_refs

    def get_fast_ref(self) -> GeneratorKernelFastRef: return self._fast_refs
